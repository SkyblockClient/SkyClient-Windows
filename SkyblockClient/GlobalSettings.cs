...
namespace SkyblockClient
{
    public class GlobalSettings
    {
        ...
        const string JAVA_ARGS_DEFAULT = "-Xmx3G -Ddg.safe=true -XX:+UnlockExperimentalVMOptions -XX:+UseG1GC -XX:G1NewSizePercent=20 -XX:G1ReservePercent=20 -XX:MaxGCPauseMillis=50 -XX:G1HeapRegionSize=32M";
